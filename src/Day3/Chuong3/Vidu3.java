...
public class Vidu3 {
	...
	public static void main(String[] args){
		try {
			...
			File destinate=new File("D:\\VNPT\\JavaNangCao\\DemoVidu\\Chuong3\\Vidu3.txt");
			Path pdestinate=Paths.get("D:\\VNPT\\JavaNangCao\\DemoVidu\\Chuong3\\Vidu3.txt");
	        //1.2 Tạo một file nguồn
			File source=new File("D:\\VNPT\\JavaNangCao\\DemoVidu\\Chuong3\\Vidu2.txt");
			Path psource=Paths.get("D:\\VNPT\\JavaNangCao\\DemoVidu\\Chuong3\\Vidu2.txt");
	       
	        //1.3 Copy
			Files.copy(psource, pdestinate, StandardCopyOption.REPLACE_EXISTING);
			//1.4 Viet them thong tin
			PrintWriter pout=new PrintWriter("D:\\VNPT\\JavaNangCao\\DemoVidu\\Chuong3\\Vidu3.txt");
			pout.append("Hello");
			pout.close();
	       ...
	       if(destinate.exists()) {
	    	  ...
	    	  // 3. Nối chuỗi
	    	   PrintWriter pw =new PrintWriter("D:\\VNPT\\JavaNangCao\\DemoVidu\\Chuong3\\Vidu3.txt");
	    	   pw.append("Hello");
	    	   pw.append("\nMy name is Trang");
	    	   pw.close();
	       }
